...
// Zeile 1, Spalte 3
J1939Win.OilPressure = gtk_digital_show_new_with_config("<b> Öldruck </b>", "<b>Bar</b>", 2, TRUE, 0.0, 10.0, 0.0, NULL, NULL);
...
max_warn = 6000;
max_limit = 7000;
J1939Win.Rpm = gtk_digital_show_new_with_config("<b> Drehzahl </b> ", "<b>1/min</b>", 0, TRUE, 0.0, 8000.0, 0.0, NULL, NULL);
g_object_set(G_OBJECT(J1939Win.Rpm), "max_warn_fg_color", &WarnFgColor, "max_warn_bg_color", &WarnBgColor,
             "max_limit_fg_color", &LimitFgColor, "max_limit_bg_color", &LimitBgColor, "max_warn", max_warn, "max_limit", max_limit, NULL);
...
// Zeile 3, Spalte 3
J1939Win.TurbochargerPressure = gtk_digital_show_new_with_config("<b> Ladedruck </b>", "<b>Bar</b>", 2, TRUE, 0.0, 5.0, 0.0, NULL, NULL);
gtk_table_attach(GTK_TABLE(table), J1939Win.TurbochargerPressure, 2, 3, 2, 3, GTK_FILL|GTK_EXPAND, GTK_FILL|GTK_EXPAND, 0, 0);

// Zeile 3, Spalte 1
J1939Win.FuelConsumptionInL = gtk_digital_show_new_with_config("<b> Verbrauch </b>", "<b>l/h</b>", 0, TRUE, 0.0, 1000.0, 0.0, NULL, NULL);
...
J1939Win.OutputPower = gtk_digital_show_new_with_config("<b> Motorleistung </b>", "<b>KW</b>", 1, TRUE, 0.0, 100.0, 0.0, NULL, NULL);
